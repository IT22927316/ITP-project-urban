...
const AddStudentProject = () => {
  ...
  return (
    <div className='w-full px-4 my-12 bg-green-400'>
        <br/><br/>
      <h2 className='mb-8 text-3xl font-bold text-center text-white'>UPLOAD YOUR PROJECT</h2>
      ...
      <div className='flex gap-8'>
        ...
        <div className='w-full'>
          <Label htmlFor="content" value="Project Summary" />
          <Textarea id="content" name='content' placeholder="Write Your Project Summary" required rows={10} />
        </div>
        </Card>

        <Card>
        <div>
            <h2 className='text-2xl font-semibold text-center underline'>Step 1 Section</h2>
        </div>
        {/* step 1 - title */}
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
        ...
        <Card>
        <div>
            <h2 className='text-2xl font-semibold text-center underline'>Step 2 Section</h2>
        </div>
      ...
      <div className='flex gap-8'>
        ...
        <Card>
        <div>
            <h2 className='text-2xl font-semibold text-center underline'>Step 3 Section</h2>
        </div>
      ...
      <div className='flex gap-8'>
        ...
        <Card>
        <div>
            <h2 className='text-2xl font-semibold text-center underline'>Step 4 Section</h2>
        </div>
      ...
      <div className='flex gap-8'>
        ...
        <Card>
        <div>
            <h2 className='text-2xl font-semibold text-center underline'>Step 5 Section</h2>
        </div>
