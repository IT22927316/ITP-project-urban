        ...
        <div className='flex flex-col md:flex-row justify-between items-center gap-12'>
            <div className='md:w-1/2'>
                ...
                <p>Green Route Delivery revolutionizes the way you receive gardening goods, seeds, and fresh produce. Our dedicated team 
                    ...
                    with every order.</p>
                <Link to="/articleshub" className='mt-5 block'><button className='bg-green-700 text-white font-semibold px-5 py-2 rounded hover:bg-black transition-all duration-300'>Delivery Drivers</button></Link>
            </div>
            <div>
