...
import { Button, Checkbox, Label, Select, TextInput, Textarea, Card} from 'flowbite-react';
import { useLoaderData, useParams } from 'react-router-dom';
import { Link } from 'react-router-dom';

const EditStudentProject = () => {
  const {id} = useParams();
  const {student_name, project_title, project_category, project_mainpic, project_summary,
  ...
  //handle student project submission
  const handleUpdate = (event) => {
      ...
      fetch(`http://localhost:5000/studentproject/${id}`,{
        ...
        //console.log(data)
        alert("Student Project Updated Successfully!")
      })
  ...
  return (
    <div className='px-4 my-12'>
      <h2 className='mb-8 text-3xl font-bold'>Update Student Prroject Details</h2>
      ...
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
          ...
          <TextInput id="student_name" name='student_name' type="text" placeholder="Student Name" required defaultValue={student_name}/>
        </div>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="project_title" name='project_title' type="text" placeholder="Project Title" required defaultValue={project_title}/>
        </div>
      </div>
      ...
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
          ...
          <TextInput id="project_mainpic" name='project_mainpic' type="text" placeholder="Cover Picture URL" required defaultValue={project_mainpic}/>
        </div>
        ...
        <div className='w-full'>
          ...
          <Textarea id="project_summary" name='project_summary' placeholder="Write Your Project Summary" required rows={10} defaultValue={project_summary}/>
        </div>
        </Card>
      ...
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step1_title" name='step1_title' type="text" placeholder="Step 1 Title - Required " required defaultValue={step1_title}/>
        </div>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step1_image" name='step1_image' type="text" placeholder="Step 1 Image - Required" required defaultValue={step1_image}/>
        </div>
      </div>
        ...
        <div className='w-full'>
          ...
          <Textarea id="step1_dedscription" name='step1_dedscription' placeholder="Write Your Step 1 Description" required rows={10} defaultValue={step1_dedscription}/>
        </div>
        </Card>
      ...
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step2_title" name='step2_title' type="text" placeholder="Step 2 Title - Required " required defaultValue={step2_title}/>
        </div>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step2_image" name='step2_image' type="text" placeholder="Step 2 Image - Required" required defaultValue={step2_image}/>
        </div>
      </div>
        ...
        <div className='w-full'>
          ...
          <Textarea id="step2_dedscription" name='step2_dedscription' placeholder="Write Your Step 2 Description" required rows={10} defaultValue={step2_dedscription}/>
        </div>
        </Card>
      ...
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step3_title" name='step3_title' type="text" placeholder="Step 3 Title - Required " required defaultValue={step3_title}/>
        </div>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step3_image" name='step3_image' type="text" placeholder="Step 3 Image - Required" required defaultValue={step3_image}/>
        </div>
      </div>
        ...
        <div className='w-full'>
          ...
          <Textarea id="step3_dedscription" name='step3_dedscription' placeholder="Write Your Step 3 Description" required rows={10} defaultValue={step3_dedscription}/>
        </div>
        </Card>
      ...
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step4_title" name='step4_title' type="text" placeholder="Step 4 Title" defaultValue={step4_title}/>
        </div>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step4_image" name='step4_image' type="text" placeholder="Step 4 Image " defaultValue={step4_image}/>
        </div>
      </div>
        ...
        <div className='w-full'>
          ...
          <Textarea id="step4_dedscription" name='step4_dedscription' placeholder="Write Your Step 4 Description"  rows={10} defaultValue={step4_dedscription}/>
        </div>
        </Card>
      ...
      <div className='flex gap-8'>
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step5_title" name='step5_title' type="text" placeholder="Step 5 Title" defaultValue={step5_title}/>
        </div>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="step5_image" name='step5_image' type="text" placeholder="Step 5 Image " defaultValue={step5_image}/>
        </div>
      </div>
        ...
        <div className='w-full'>
          ...
          <Textarea id="step5_dedscription" name='step5_dedscription' placeholder="Write Your Step 5 Description"  rows={10} defaultValue={step5_dedscription}/>
        </div>
        </Card>
        ...
        <div className='w-full'>
          ...
          <Textarea id="faliures" name='faliures' placeholder="Write Your Faliures Here" required rows={10} defaultValue={faliures}/>
        </div>
        </Card>
      ...
      <div className='flex justify-end items-center space-x-4 px-4 lg:px-1'>
            ...
            <Button type="submit" className='w-48 h-10 bg-green-500'>Update Project</Button>
        </div>
